...
class CarroAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): CarroAdapter.CarrosViewHolder {
    ...
    override fun onBindViewHolder(holder: CarrosViewHolder, position: Int) {
        ...
        //declarar a variavel view para facilitar o acesso abaixo
        //a view contem as variaveis definidas no XML  ( lembre do nome de cada id )
